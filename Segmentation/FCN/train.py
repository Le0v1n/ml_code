...
def main(args):
    ...
    if args.aux:  # 如果使用辅助分类器（Aux的学习率是初始学习率的10倍，这么做的目的是防止梯度过小，无法回传到浅层）
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"C:\Users\Leovin\Desktop\Educational_Robot\DeepLearningCode\data_set", help="VOCdevkit root")
    parser.add_argument("--num-classes", default=20, type=int)
    parser.add_argument("--aux", default=True, type=bool, help="auxilier loss-是否使用辅助分类器")
    parser.add_argument("--device", default="cuda", help="training device")
    parser.add_argument("-b", "--batch-size", default=4, type=int)
    parser.add_argument("--epochs", default=3, type=int, metavar="N", help="number of total epochs to train")
